...
| pattern                     | variations                                                                                                                                                                                                                                                                                                                                                                                                 |
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| LOT = level order traversal | - [[Binary Tree zigzag traversal]]<br>- N-ary Tree Zigzag LOT with constraints <br>- longest path in Binary (N-ary) Tree with LOT<br>- path sum      in Binary (N-ary) Tree with LOT<br>- convert tree to zigzag tree<br>- distance in zigzag binary tree<br>- Zigzag with missing nodes (Handle zigzag traversal in trees that may not be complete, requiring dynamic adjustment of traversal paths )<br> |
| max depth of tree           | - [[max depth of tree]]<br>- [[Diameter of a Tree]]<br>- [[max path sum of a tree]]<br><br>                                                                                                                                                                                                                                                                                                                |
| tree traversal              | - [[same tree or not]]<br>                                                                                                                                                                                                                                                                                                                                                                                 |
