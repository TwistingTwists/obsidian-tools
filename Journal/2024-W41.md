...
As I understand, in stream processing of data, there are a few steps 
1. ingestion  (connector)
2. (maybe) stateless / stateful processing at ingestion
3. more transforms
	1. Feldera fits in here. =>  does these incrementally.
4. to sink (another stream, db)
