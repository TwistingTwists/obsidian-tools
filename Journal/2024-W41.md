...
#### Remove ERR_NETWORK_CHANGED

| measure                                                                                                    | outcome |
| ---------------------------------------------------------------------------------------------------------- | ------- |
| ```<br>sysctl -w net.ipv6.conf.all.disable_ipv6=1<br>sysctl -w net.ipv6.conf.default.disable_ipv6=1<br>``` |         |
|                                                                                                            |         |
...
- [ ] https://x.com/hkproj
- [ ] AI 
	- [ ] synthetic data generation in AI  - https://docs.bespokelabs.ai/bespoke-curator/getting-started/quick-tour
	- [ ] 
...
- Correct impelmentation of threads would have same perf as event based one.
	- Current implementation of threads has consolidated to kernel-based threads and user threads whose context switch cost is high. Hence, programs end up doing thread-per-core with eventloop
	- io is much faster than CPU - really?


##### Tree Structured Concurrency
- [Golang slides by ROb Pike](https://go.dev/talks/2012/concurrency.slide#57)
- 
...
<h6 class="h6">Real time data's unifying abstraction  </h6> 
...
<h6 class="h6"> Handling overload </h6> 
https://medium.com/@jlouis666/full-queues-and-their-woes-18d89c6f9740


- PG advisory locks 
https://chatgpt.com/share/67400939-e9b4-8009-b3f2-b796d442d6fe

Sample Axum Server in Rust - Vaultwarden
...
[Matt Klein - Envoy](https://x.com/mattklein123/status/1130206773078421504?ref_src=twsrc%5Etfw%7Ctwcamp%5Etweetembed%7Ctwterm%5E1130206773078421504%7Ctwgr%5E1f6f7ac1af37db7364046a232d575b90fafd6d69%7Ctwcon%5Es1_&ref_url=https%3A%2F%2Fcdn.embedly.com%2Fwidgets%2Fmedia.html%3Ftype%3Dtext2Fhtmlkey%3Da19fcc184b9711e1b4764040d3dc5c07schema%3Dtwitterurl%3Dhttps3A%2F%2Ftwitter.com%2Fmattklein123%2Fstatus%2F1130206773078421504image%3Dhttps3A%2F%2Fi.embed.ly%2F1%2Fimage3Furl3Dhttps253A252F252Fpbs.twimg.com252Fprofile_images252F769023810532216833252FfNvJJo1b_400x400.jpg26key3Da19fcc184b9711e1b4764040d3dc5c07)
...
SIDE PROJECT
- [ ] 
- [ ] Oxc Rust JS Parser - semantic analysis
- [ ] Copy checker plan in elixir?  - Vue + Ash?

UPSKILL
- [ ] Graph algo 
- [ ] Rust Ardan Labs?
- [ ] Jon hoo smart pointers

RANDOM
- [ ] movie janakpuri  tomorrow
- [ ] upskilling -- feedback (context) + follow up 
...
YRAL 
- [ ] block room api call 
- [ ] secure web proxy exploration
- [ ] dev neuron deploy
- [ ] payments api call 
- [ ] Backend integration calls with principal ID
- [ ] 
...
| --------------------------------------------------------------------------------------------------------------------- | ---------------------------------- |
| [Clustering using Gensim Python](http://brandonrose.org/clustering#Latent-Dirichlet-Allocation)                       |                                    |
| [dynamic topic modelling using gensim ](https://rare-technologies.com/understanding-and-coding-dynamic-topic-models/) | nltk also has tokenization library |
|                                                                                                                       |                                    |
|                                                                                                                       |                                    |
...
col * row   , (a) categories (num_column), num_rows

dof_between =  a - 1 
dof_within =  N - a
4. F_table value  = F(dof_between, dof_within)
5. F value = (variance between sample) / (variance within sample)
...
### PEG grammars 
Python's Guido series -- https://medium.com/@gvanrossum_83706/peg-parsers-7ed72462f97c


### CPPCon 2017

- https://github.com/CppCon/CppCon2017?tab=readme-ov-file
...
#### Viewstamped replication + Paxos + Raft

https://medium.com/@polyglot_factotum/understand-viewstamped-replication-with-rust-automerge-and-tla-7a94e9e4d553
https://automerge.org/automerge-binary-format-spec/#_terminology_and_conventions
https://github.com/gterzian/understand-vsr
...
### data processing - timely dataflow and differential dataflow

- https://github.com/asavinov/prosto
- https://github.com/apache/datafusion-ballista
- https://vlcn.io/blog/differential-dataflow


- DIFFERENTIAL DATAFLOW 
	- https://github.com/TimelyDataflow/differential-dataflow/tree/master/dogsdogsdogs#worst-case-optimal-joins
	- https://timelydataflow.github.io/differential-dataflow/
	- https://materialize.com/blog/life-in-differential-dataflow/
	- http://muratbuffalo.blogspot.com/2017/11/on-dataflow-systems-naiad-and-tensorflow.html?m=1
	- https://www.youtube.com/watch?v=yyhMI9r0A9E
	- https://github.com/TimelyDataflow/timely-dataflow/blob/master/timely/Cargo.toml
	- https://job-boards.greenhouse.io/materialize/jobs/5357900004
...
### WASM 
- component model 
	- https://component-model.bytecodealliance.org/#contributing
- wasmtime - https://wasmtime.dev/


#### Memory allocators 
https://www.youtube.com/playlist?list=PLEMXAbCVnmY6Azbmzj3BiC3QRYHE9QoG7
https://www.youtube.com/watch?v=L79vSP8yV2g
https://www.youtube.com/watch?v=-qFUczhuVZc
https://www.youtube.com/watch?v=3IAlJSIjvH0
https://www.youtube.com/watch?v=vHWiDx_l4V0
https://www.p99conf.io/session/understanding-request-latency-with-wallclock-profiling/
...
- [ ] blog publishing 
- [ ] naman data analysis 
- [ ] meeting vaibhav upsc superkalam
- [ ] Rust - oxc parser crucible -- docs 
- [ ] Elixir ML - Hands On LLM - in Elixir By Jay Alammar 
- [ ] 
