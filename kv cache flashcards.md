[Sign in - Google Accounts](https://notebooklm.google.com/notebook/9e353e0a-4f6a-4b32-80f2-f1ce921529db?authuser=1) -- notebookLm 
...
Q: Why can't we allocate KV cache memory dynamically as sequence length grows? Consider: GPU memory allocation latency, tensor contiguousness requirements for 
"memory is cheap" assumption?
