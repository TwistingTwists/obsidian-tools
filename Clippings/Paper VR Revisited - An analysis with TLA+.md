...
[Viewstamped Replication Revisited](https://pmg.csail.mit.edu/papers/vr-revisited.pdf) is a state-machine replication (SMR) protocol and a revision of the original [Viewstamped Replication paper](http://pmg.csail.mit.edu/papers/vr.pdf).
...
Fig 2. No matter the cluster size, all majority quorums overlap. In other words, there does not exist two majority quorums that do not overlap.
...
This analysis uses TLA+ and its model checker. If you are new to TLA+ then I wrote an [introduction to its concepts](https://medium.com/splunk-maas/detecting-bugs-in-data-infrastructure-using-formal-methods-704fde527c58) as part of my write-up on how I found a defect in Apache BookKeeper with TLA+. Plus there is always the excellent [TLA+ video course](https://www.youtube.com/@tlavideocourse8540) by Leslie Lamport himself.
