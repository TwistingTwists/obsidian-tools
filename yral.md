...
| <input type="checkbox" checked id="7110f0">   | deploy EEP with axum                                                                                                                                                                                   | deploy      | EEP     |
| <input type="checkbox" checked id="03570a">   | test on nofeebooking (with EEP)                                                                                                                                                                        | testing     | EEP     |
...
|                                               | UI fixes <br><input type="checkbox" unchecked id="4eb28a"> back button on hotel-details page<br><input type="checkbox" unchecked id="1f04e6"> search page bug - re-search a new city from the page<br> |             |         |
|                                               |                                                                                                                                                                                                        |             |         |
...
I know that  if I have a dapp, I can create a new SNS and hand over the dapp to the newly created SNS. this process is clearly laid out by ICP docs.

What if I have a dapp (`ed6lv-7aaaa-aaaai-aq4pa-cai` - estate_backend) and want to add it to the existing SNS (estate-dao) ?
